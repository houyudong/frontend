...
// 新实验
export const NewExperiment: Story = {
  render: () => (
    <ExperimentCard
      id={2}
      title='定时器中断控制'
...
// 热门实验
export const PopularExperiment: Story = {
  render: () => (
    <ExperimentCard
      id={3}
      title='按键输入 - 用户交互'
...
// 新的热门实验
export const NewAndPopularExperiment: Story = {
  render: () => (
    <ExperimentCard
      id={4}
      title='UART通信实现'
...
// 高级实验
export const AdvancedExperiment: Story = {
  render: () => (
    <ExperimentCard
      id={5}
      title='DMA内存到外设传输'
...
// 多标签实验
export const MultiTagExperiment: Story = {
  render: () => (
    <ExperimentCard
      id={6}
      title='智能环境监控系统'
