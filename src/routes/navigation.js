 ...
 * @property {string} path - 导航项路径
 * @property {string} icon - 导航项图标
 * @property {string[]} [roles] - 允许访问的角色列表，不设置表示所有角色都可访问
 * @property {NavItem[]} [children] - 子导航项
 * @property {boolean} [divider] - 是否在此项后添加分隔线
 ...
 * @returns {NavItem[]} 过滤后的导航项
 */
export const getAccessibleNavigation = (role) => {
  // 过滤顶级导航项
