 ...
 * @property {React.ComponentType} component - 路由组件
 * @property {boolean} [exact=false] - 是否精确匹配
 * @property {string[]} [roles] - 允许访问的角色列表，不设置表示所有角色都可访问
 * @property {boolean} [auth=true] - 是否需要认证
...
const routes = [
  ...
  // 已删除 MermaidDemoPage 和 ComponentsPage 的路由
  // 用户页面路由
  {
    path: '/profile',
