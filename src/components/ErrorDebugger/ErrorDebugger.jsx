 ...
 * @param {string} props.errorCode - 错误代码
 * @param {string} props.sourceCode - 源代码（可选）
 * @param {string} props.mcuModel - MCU型号
 * @param {Function} props.onUpdateSolution - 解决方案更新回调
 * @returns {ReactElement} ErrorDebugger组件
 */
const ErrorDebugger = ({ errorCode, sourceCode, mcuModel, onUpdateSolution }) => {
...
ErrorDebugger.propTypes = {
  errorCode: PropTypes.string.isRequired,
  sourceCode: PropTypes.string,
  mcuModel: PropTypes.string.isRequired,
  onUpdateSolution: PropTypes.func
};
