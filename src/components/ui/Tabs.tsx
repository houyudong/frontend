...
type TabVariant = 'line' | 'enclosed' | 'solid';
type TabColorScheme = 'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info';
 ...
 * Tabs.Panel - 标签面板组件
 */
const TabPanel: React.FC<TabPanelProps> = ({ children, id, className = '', ...props }) => {
